...
module.exports = {
  I2C: async (busNum, addr = 0x10, provider = 'i2c-bus') => {
    if (typeof busNum === 'object' && bus._bus) {
...
module.exports.I2C.open = (busNum, addr = 0x10, provider = 'i2c-bus') => {
  return require(provider).openPromisified(busNum).then((bus) => module.exports.I2C(bus, addr))
}